...
function newTaskDraft(types: TaskType[]): TaskDraft {
  const taskType = types[0]?.key ?? "system.log_message";
  return {
    name: "", description: "", taskType,
    parameters: taskType === "system.log_message" ? '{\n  "message": ""\n}' : "{}",
