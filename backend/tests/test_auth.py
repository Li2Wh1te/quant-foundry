...
class AuthenticationTestCase(unittest.TestCase):
    ...
    def test_protects_business_routes_and_exempts_readiness(self) -> None:
        protected_operations = (
            ("/api/admin/data-store/datasets", "get"),
            ("/api/admin/data-store/datasets/{dataset}", "get"),
            ("/api/admin/data-store/status", "get"),
            ("/api/admin/data-store/issues", "get"),
            ("/api/admin/data-store/query", "post"),
            ("/api/auth/verify", "get"),
