...
class RecordRequirement(BaseModel):
    ...
    dataset_id: Literal['instrument.reference', 'fund.company', 'fund.manager', 'fund.profile', 'fund.manager_experience', 'fund.nav_snapshot', 'fund.offering_snapshot', 'fund.quota_summary_snapshot', 'fund.quota_list_snapshot', 'market.popularity_snapshot', 'market.rising_popularity_snapshot', 'market.popularity_history_snapshot', 'market.calendar',
