...
class RecordRequirement(BaseModel):
    ...
    dataset_id: Literal['instrument.reference', 'fund.company', 'fund.manager', 'fund.profile', 'fund.manager_experience', 'fund.nav_snapshot', 'fund.offering_snapshot', 'market.calendar',
