...
class RecordRequirement(BaseModel):
    ...
    dataset_id: Literal['operations.etf_mapping_audit', 'operations.etf_daily_revision', 'operations.corporate_action_source_fact', 'operations.corporate_action_fact', 'operations.corporate_action_coverage', 'operations.trading_status_source_fact', 'operations.trading_status_fact', 'operations.trading_status_coverage', 'operations.trading_status_revision', 'operations.empty_local_scope', 'operations.import_progress', 'fund.news_window', 'market.stock_anomaly_window', 'market.rank_trend_window', 'fund.reported_holdings_window', 'fund.reported_stock_holdings_window', 'fund.reported_bond_holdings_window', 'market.financial_indicator_window', 'fund.financial_indicator_window', 'fund.income_window', 'fund.balance_window', 'market.income_window', 'market.balance_window', 'market.cash_flow_window', 'fund.allocation_window', 'fund.industry_window', 'fund.holder_composition_window', 'fund.top_holder_window', 'fund.dividend_window', 'market.corporate_action_window', 'fund.manager_performance_window', 'fund.manager_style_snapshot', 'fund.return_snapshot', 'fund.drawdown_snapshot', 'fund.performance_window', 'market.dragon_tiger_snapshot', 'market.auction_snapshot', 'market.auction_benchmark_snapshot', 'market.limit_up_snapshot', 'market.limit_down_snapshot', 'market.limit_break_snapshot', 'market.anomaly_snapshot', 'market.limit_ladder_window', 'market.stock_quote_snapshot', 'market.etf_quote_snapshot', 'market.index_quote_snapshot', 'market.stock_valuation_snapshot', 'instrument.reference', 'fund.company', 'fund.manager', 'fund.profile', 'fund.manager_experience', 'fund.nav_snapshot', 'fund.offering_snapshot', 'market.stock_daily_window', 'market.etf_daily_window', 'market.index_daily_window', 'fund.quota_summary_snapshot', 'fund.quota_list_snapshot', 'market.popularity_snapshot', 'market.rising_popularity_snapshot', 'market.popularity_history_snapshot', 'market.calendar',
